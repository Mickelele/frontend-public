...
export async function enrollStudentToGroupWithData(studentData) {
...
export async function changePseudonim(id, pseudonim) {
    return await apiFetch(`/uczniowie/${id}/pseudonim`, {
        method: 'PATCH',
        body: { pseudonim }
    }, 'user');
}
